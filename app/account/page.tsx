...
export default function AccountAuthPage() {
  ...
  return (
    <div className="min-h-[85vh] flex bg-[#F7F5F0]" style={{ fontFamily: "var(--font-bangla), var(--font-sans), sans-serif" }}>
      <div className="hidden md:flex md:w-1/2 items-center justify-center relative overflow-hidden" style={{ background: "linear-gradient(160deg, #0F2637, #14212B)" }}>
        <div className="relative z-10 text-center px-10">
          <p className="text-[12px] tracking-[0.25em] text-[#B28B52] mb-5">RSL &mdash; EST. 2026</p>
          <h2 className="text-4xl mb-4 text-[#F7F5F0]" style={{ fontFamily: "var(--font-display)" }}>
            Define Your Style.
          </h2>
          <p className="text-[#F7F5F0]/60 max-w-xs mx-auto text-sm">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          ...
          <p className="text-[11px] tracking-[0.2em] text-[#B28B52] mb-3">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="text-[11px] tracking-[0.15em] text-[#66727A] mb-2 block">EMAIL</label>
              <input
                type="email"
                value={email}
            ...
            {isSignUp ? (
              <>
                <div className="mb-4">
                  <label className="text-[11px] tracking-[0.15em] text-[#66727A] mb-2 block">PHONE NUMBER</label>
                  <input
                    type="tel"
                    value={phone}
            ...
            <div className="mb-7">
              <label className="text-[11px] tracking-[0.15em] text-[#66727A] mb-2 block">PASSWORD</label>
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full border border-[#D7DDE0] px-4 py-3 pr-11 bg-transparent focus:outline-none focus:border-[#B28B52] transition-colors"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  aria-label={showPassword ? "Hide password" : "Show password"}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#66727A] hover:text-[#B28B52] transition-colors"
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 text-[13px] tracking-[0.15em] bg-[#14212B] text-[#F7F5F0] hover:bg-[#B28B52] transition-colors disabled:opacity-60 mb-6"
            >
            ...
            <button
              ...
              className="w-full text-center text-sm text-[#66727A] hover:text-[#B28B52] transition-colors"
            >
          ...
          <div className="mt-10 pt-6 border-t border-[#D7DDE0] text-center">
            <Link href="/" className="text-[12px] tracking-[0.08em] text-[#66727A] hover:text-[#B28B52] transition-colors">
