export default function SupportPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-16 min-h-[50vh]">
      ...
      <p className="text-[#66727A] mb-4">We are here to help you with any questions about your order, products, or account.</p>

      <div className="flex flex-col gap-3 mb-6">
        <a href="mailto:rslbdshop@gmail.com" className="text-[#66727A] hover:text-[#B28B52] transition-colors w-fit">Email: rslbdshop@gmail.com</a>

        <a href="https://wa.me/8801409000421" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#66727A] hover:text-[#B28B52] transition-colors w-fit">
        ...
        <a href="https://www.facebook.com/share/18S865vmAM/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#66727A] hover:text-[#B28B52] transition-colors w-fit">
      ...
      <p className="text-[#66727A]">You can also reach out to us through our social media pages for a faster response.</p>
    </div>
  );
}
