export default function ShippingReturnsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-16 min-h-[60vh]">
      <p className="text-[11px] tracking-[0.2em] text-[#9C7A44] mb-3">RSL / CUSTOMER CARE</p>
      <h1 className="text-3xl md:text-4xl mb-8" style={{ fontFamily: "var(--font-display)" }}>Shipping & Returns</h1>

      <div className="space-y-10 text-[#6E675C] leading-relaxed">
        <section>
          <h2 className="text-xl text-[#14120F] mb-3" style={{ fontFamily: "var(--font-display)" }}>Delivery</h2>
        ...
        <section>
          <h2 className="text-xl text-[#14120F] mb-3" style={{ fontFamily: "var(--font-display)" }}>Shipping charges</h2>
        ...
        <section>
          <h2 className="text-xl text-[#14120F] mb-3" style={{ fontFamily: "var(--font-display)" }}>Exchange and returns</h2>
        ...
        <section>
          <h2 className="text-xl text-[#14120F] mb-3" style={{ fontFamily: "var(--font-display)" }}>How to request help</h2>
          ...
          <a href="https://wa.me/8801409000421" target="_blank" rel="noopener noreferrer" className="inline-flex mt-4 text-[#14120F] border-b border-[#14120F] pb-1 hover:text-[#9C7A44] hover:border-[#9C7A44] transition-colors">CONTACT US ON WHATSAPP →</a>
        </section>
      </div>
    </div>
  );
